...
void showQuickMessageBottomSheet(BuildContext context, List<String> amigos) {
              ...
              children: quickMessages.map((item) {
                return ListTile(
                  ...
                  onTap: () {
                    ...
                    _handleQuickMessage(context, item['label'], amigos);
                  },
                );
              }).toList(),
            ),
...
void _handleQuickMessage(BuildContext context, String message, List<String> amigos) {
  enviarNotificacaoOneSignal(
      playerId: amigos,
      titulo: message,
      mensagem: "De: João Douglas");
